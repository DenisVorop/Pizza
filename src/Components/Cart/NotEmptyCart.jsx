        ...
        <div className="cart">
            ...
            <div className="content__items">
                {
                    addedPizzas.map((obj, index) => {
                        return <CartItem
                            ...
                            removeSelectItem={onRemoveItem}
                            addItem={onAddItemCount}
                            removeItem={onRemoveItemCount}
                        />
                    })
                }
            </div>
            <div className="cart__bottom">
                ...
                <div className="cart__bottom-buttons">
                    ...
                    <div className="button pay-btn" onClick={onCartOrder}>
